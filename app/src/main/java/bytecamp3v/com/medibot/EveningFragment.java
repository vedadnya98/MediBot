...
public class EveningFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_evening,container,false);
        medicinesView = rootView.findViewById(R.id.eveningList);
        ...
        mRef = FirebaseDatabase.getInstance().getReference().child("Person").child(name).child("evening");
